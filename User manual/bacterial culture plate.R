...
ggplot(agar,aes(x,y))+
  geom_polygon(color="black",fill="grey50",alpha=0.2,linewidth=1)+
  geom_polygon(aes(x=0.98*x,y=0.98*y),color="black",fill="#ffd200",alpha=0.3,linewidth=1)+
  geom_polygon(aes(x=0.2*x+disc$x[1],y=0.2*y+disc$y[1]),fill="#ffd200",color="grey85",alpha=0.7)+
  geom_polygon(aes(x=0.1*x+disc$x[2],y=0.1*y+disc$y[2]),fill="#ffd200",color="grey85",alpha=0.7)+
  geom_polygon(aes(x=0.25*x+disc$x[3],y=0.25*y+disc$y[3]),fill="#ffd200",color="grey85",alpha=0.7)+
  geom_polygon(aes(x=0.15*x+disc$x[5],y=0.15*y+disc$y[5]),fill="#ffd200",color="grey85",alpha=0.7)+
  geom_polygon(aes(x=0.18*x+disc$x[6],y=0.18*y+disc$y[6]),fill="#ffd200",color="grey85",alpha=0.7)+
